...
/////Reklam////
client.on('ready' , () => {
var join = client.channels.get("877603234263482388")/// ئاید ڤۆیس
if (join) join.join()
})
...
if (message.content.startsWith("https://discord.gg/")) {
  ...
  message.author.send(`> https://discord.gg/6UVtqFzPgB`)/// لینکە سیرڤەرە خۆت
...
client.login("ODc4MDA4MzA0MDA0MTI4Nzk4.YR669A.BwzjhzO1DPzkRRw-UbVXUHiCWK0");
